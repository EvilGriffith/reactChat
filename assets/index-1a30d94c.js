 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uc{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,n){const r=new Y(ms,e),i=new Y(ms,n);return this.compare(r,i)!==0}minPost(){return Y.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class J2 extends Uc{constructor(e){super(),this.indexPath_=e,C(!q(e)&&Q(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,n){const r=this.extractChild(e.node),i=this.extractChild(n.node),s=r.compareTo(i);return s===0?Ns(e.name,n.name):s}makePost(e,n){const r=Ze(e),i=ee.EMPTY_NODE.updateChild(this.indexPath_,r);return new Y(n,i)}maxPost(){const e=ee.EMPTY_NODE.updateChild(this.indexPath_,ba);return new Y(ii,e)}toString(){return DS(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Z2 extends Uc{compare(e,n){const r=e.node.compareTo(n.node);return r===0?Ns(e.name,n.name):r}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return Y.MIN}maxPost(){return Y.MAX}makePost(e,n){const r=Ze(e);return new Y(n,r)}toString(){return".value"}}const eV=new Z2;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fu(){return{value:null,children:new Map}}function BS(t,e,n){if(q(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const r=Q(e);t.children.has(r)||t.children.set(r,Fu());const i=t.children.get(r);e=le(e),BS(i,e,n)}}function Nf(t,e,n){t.value!==null?n(e,t.value):oV(t,(r,i)=>{const s=new de(e.toString()+"/"+r);Nf(i,s,n)})}function oV(t,e){t.children.forEach((n,r)=>{e(r,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bu{constructor(e,n,r){this.path=e,this.affectedTree=n,this.revert=r,this.type=sn.ACK_USER_WRITE,this.source=jS()}operationForChild(e){if(q(this.path)){if(this.affectedTree.value!=null)return C(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new de(e));return new bu(re(),n,this.revert)}}else return C(Q(this.path)===e,"operationForChild called for unrelated child."),new bu(le(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class si{constructor(e,n,r){this.source=e,this.path=n,this.snap=r,this.type=sn.OVERWRITE}operationForChild(e){return q(this.path)?new si(this.source,re(),this.snap.getImmediateChild(e)):new si(this.source,le(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ua{constructor(e,n,r){this.source=e,this.path=n,this.children=r,this.type=sn.MERGE}operationForChild(e){if(q(this.path)){const n=this.children.subtree(new de(e));return n.isEmpty()?null:n.value?new si(this.source,re(),n.value):new ua(this.source,re(),n)}else return C(Q(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new ua(this.source,le(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zm{constructor(e,n,r){this.node_=e,this.fullyInitialized_=n,this.filtered_=r}isFullyInitialized(){return this.fullyInitialized_}isFiltered(){return this.filtered_}isCompleteForPath(e){if(q(e))return this.isFullyInitialized()&&!this.filtered_;const n=Q(e);return this.isCompleteForChild(n)}isCompleteForChild(e){return this.isFullyInitialized()&&!this.filtered_||this.node_.hasChild(e)}getNode(){return this.node_}}function hV(t,e,n,r){const i=[],s=[];return e.forEach(o=>{o.type==="child_changed"&&t.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&s.push(iV(o.childName,o.snapshotNode))}),Qs(t,i,"child_removed",e,r,n),Qs(t,i,"child_added",e,r,n),Qs(t,i,"child_moved",s,r,n),Qs(t,i,"child_changed",e,r,n),Qs(t,i,"value",e,r,n),i}function Qs(t,e,n,r,i,s){const o=r.filter(a=>a.type===n);o.sort((a,l)=>fV(t,a,l)),o.forEach(a=>{const l=dV(t,a,s);i.forEach(u=>{u.respondsTo(a.type)&&e.push(u.createEvent(l,t.query_))})})}function dV(t,e,n){return e.type==="value"||e.type==="child_removed"||(e.prevName=n.getPredecessorChildName(e.childName,e.snapshotNode,t.index_)),e}function fV(t,e,n){if(e.childName==null||n.childName==null)throw Ts("Should only compare child_ events.");const r=new Y(e.childName,e.snapshotNode),i=new Y(n.childName,n.snapshotNode);return t.index_.compare(r,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qt{constructor(e){this.writeTree_=e}static empty(){return new Qt(new ae(null))}}function Co(t,e,n){if(q(e))return new Qt(new ae(n));{const r=t.writeTree_.findRootMostValueAndPath(e);if(r!=null){const i=r.path;let s=r.value;const o=Ot(i,e);return s=s.updateChild(o,n),new Qt(t.writeTree_.set(i,s))}else{const i=new ae(n),s=t.writeTree_.setTree(e,i);return new Qt(s)}}}function gv(t,e,n){let r=t;return bt(n,(i,s)=>{r=Co(r,Ve(e,i),s)}),r}function _v(t,e){if(q(e))return Qt.empty();{const n=t.writeTree_.setTree(e,new ae(null));return new Qt(n)}}function Df(t,e){return pi(t,e)!=null}function pi(t,e){const n=t.writeTree_.findRootMostValueAndPath(e);return n!=null?t.writeTree_.get(n.path).getChild(Ot(n.path,e)):null}function yv(t){const e=[],n=t.writeTree_.value;return n!=null?n.isLeafNode()||n.forEachChild(tt,(r,i)=>{e.push(new Y(r,i))}):t.writeTree_.children.inorderTraversal((r,i)=>{i.value!=null&&e.push(new Y(r,i.value))}),e}function dr(t,e){if(q(e))return t;{const n=pi(t,e);return n!=null?new Qt(new ae(n)):new Qt(t.writeTree_.subtree(e))}}function Of(t){return t.writeTree_.isEmpty()}function gs(t,e){return qS(re(),t.writeTree_,e)}function qS(t,e,n){if(e.value!=null)return n.updateChild(t,e.value);{let r=null;return e.children.inorderTraversal((i,s)=>{i===".priority"?(C(s.value!==null,"Priority writes must always be leaf nodes"),r=s.value):n=qS(Ve(t,i),s,n)}),!n.getChild(t).isEmpty()&&r!==null&&(n=n.updateChild(Ve(t,".priority"),r)),n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class PV{getCompleteChild(e){return null}getChildAfterChild(e,n,r){return null}}const e1=new PV;class tg{constructor(e,n,r=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=r}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const r=this.optCompleteServerCache_!=null?new Zm(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return eg(this.writes_,e,r)}}getChildAfterChild(e,n,r){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:oi(this.viewCache_),s=AV(this.writes_,i,n,1,r,e);return s.length===0?null:s[0]}}function NV(t,e){C(e.eventCache.getNode().isIndexed(t.filter.getIndex()),"Event snap not indexed"),C(e.serverCache.getNode().isIndexed(t.filter.getIndex()),"Server snap not indexed")}function xV(t,e,n,r,i){const s=new kV;let o,a;if(n.type===sn.OVERWRITE){const u=n;u.source.fromUser?o=Mf(t,e,u.path,u.snap,r,i,s):(C(u.source.fromServer,"Unknown source."),a=u.source.tagged||e.serverCache.isFiltered()&&!q(u.path),o=$u(t,e,u.path,u.snap,r,i,a,s))}else if(n.type===sn.MERGE){const u=n;u.source.fromUser?o=OV(t,e,u.path,u.children,r,i,s):(C(u.source.fromServer,"Unknown source."),a=u.source.tagged||e.serverCache.isFiltered(),o=Vf(t,e,u.path,u.children,r,i,a,s))}else if(n.type===sn.ACK_USER_WRITE){const u=n;u.revert?o=VV(t,e,u.path,r,i,s):o=LV(t,e,u.path,u.affectedTree,r,i,s)}else if(n.type===sn.LISTEN_COMPLETE)o=MV(t,e,n.path,r,s);else throw Ts("Unknown operation type: "+n.type);const l=s.getChanges();return DV(e,o,l),{viewCache:o,changes:l}}function DV(t,e,n){const r=e.eventCache;if(r.isFullyInitialized()){const i=r.getNode().isLeafNode()||r.getNode().isEmpty(),s=xf(t);(n.length>0||!t.eventCache.isFullyInitialized()||i&&!r.getNode().equals(s)||!r.getNode().getPriority().equals(s.getPriority()))&&n.push(tV(xf(e)))}}function t1(t,e,n,r,i,s){const o=e.eventCache;if(Uu(r,n)!=null)return e;{let a,l;if(q(n))if(C(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const u=oi(e),c=u instanceof ee?u:ee.EMPTY_NODE,h=XS(r,c);a=t.filter.updateFullNode(e.eventCache.getNode(),h,s)}else{const u=Lf(r,oi(e));a=t.filter.updateFullNode(e.eventCache.getNode(),u,s)}else{const u=Q(n);if(u===".priority"){C(vr(n)===1,"Can't have a priority with additional path components");const c=o.getNode();l=e.serverCache.getNode();const h=vv(r,n,c,l);h!=null?a=t.filter.updatePriority(c,h):a=o.getNode()}else{const c=le(n);let h;if(o.isCompleteForChild(u)){l=e.serverCache.getNode();const d=vv(r,n,o.getNode(),l);d!=null?h=o.getNode().getImmediateChild(u).updateChild(c,d):h=o.getNode().getImmediateChild(u)}else h=eg(r,u,e.serverCache);h!=null?a=t.filter.updateChild(o.getNode(),u,h,c,i,s):a=o.getNode()}}return So(e,a,o.isFullyInitialized()||q(n),t.filter.filtersNodes())}}function $u(t,e,n,r,i,s,o,a){const l=e.serverCache;let u;const c=o?t.filter:t.filter.getIndexedFilter();if(q(n))u=c.updateFullNode(l.getNode(),r,null);else if(c.filtersNodes()&&!l.isFiltered()){const p=l.getNode().updateChild(n,r);u=c.updateFullNode(l.getNode(),p,null)}else{const p=Q(n);if(!l.isCompleteForPath(n)&&vr(n)>1)return e;const _=le(n),E=l.getNode().getImmediateChild(p).updateChild(_,r);p===".priority"?u=c.updatePriority(l.getNode(),E):u=c.updateChild(l.getNode(),p,E,_,e1,null)}const h=KS(e,u,l.isFullyInitialized()||q(n),c.filtersNodes()),d=new tg(i,h,s);return t1(t,h,n,i,d,a)}function Mf(t,e,n,r,i,s,o){const a=e.eventCache;let l,u;const c=new tg(i,e,s);if(q(n))u=t.filter.updateFullNode(e.eventCache.getNode(),r,o),l=So(e,u,!0,t.filter.filtersNodes());else{const h=Q(n);if(h===".priority")u=t.filter.updatePriority(e.eventCache.getNode(),r),l=So(e,u,a.isFullyInitialized(),a.isFiltered());else{const d=le(n),p=a.getNode().getImmediateChild(h);let _;if(q(d))_=r;else{const y=c.getCompleteChild(h);y!=null?xS(d)===".priority"&&y.getChild(OS(d)).isEmpty()?_=y:_=y.updateChild(d,r):_=ee.EMPTY_NODE}if(p.equals(_))l=e;else{const y=t.filter.updateChild(a.getNode(),h,_,d,c,o);l=So(e,y,a.isFullyInitialized(),t.filter.filtersNodes())}}}return l}function Ev(t,e){return t.eventCache.isCompleteForChild(e)}function OV(t,e,n,r,i,s,o){let a=e;return r.foreach((l,u)=>{const c=Ve(n,l);Ev(e,Q(c))&&(a=Mf(t,a,c,u,i,s,o))}),r.foreach((l,u)=>{const c=Ve(n,l);Ev(e,Q(c))||(a=Mf(t,a,c,u,i,s,o))}),a}function wv(t,e,n){return n.foreach((r,i)=>{e=e.updateChild(r,i)}),e}function Vf(t,e,n,r,i,s,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,u;q(n)?u=r:u=new ae(null).setTree(n,r);const c=e.serverCache.getNode();return u.children.inorderTraversal((h,d)=>{if(c.hasChild(h)){const p=e.serverCache.getNode().getImmediateChild(h),_=wv(t,p,d);l=$u(t,l,new de(h),_,i,s,o,a)}}),u.children.inorderTraversal((h,d)=>{const p=!e.serverCache.isCompleteForChild(h)&&d.value===null;if(!c.hasChild(h)&&!p){const _=e.serverCache.getNode().getImmediateChild(h),y=wv(t,_,d);l=$u(t,l,new de(h),y,i,s,o,a)}}),l}function LV(t,e,n,r,i,s,o){if(Uu(i,n)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(r.value!=null){if(q(n)&&l.isFullyInitialized()||l.isCompleteForPath(n))return $u(t,e,n,l.getNode().getChild(n),i,s,a,o);if(q(n)){let u=new ae(null);return l.getNode().forEachChild(Yi,(c,h)=>{u=u.set(new de(c),h)}),Vf(t,e,n,u,i,s,a,o)}else return e}else{let u=new ae(null);return r.foreach((c,h)=>{const d=Ve(n,c);l.isCompleteForPath(d)&&(u=u.set(c,l.getNode().getChild(d)))}),Vf(t,e,n,u,i,s,a,o)}}function MV(t,e,n,r,i){const s=e.serverCache,o=KS(e,s.getNode(),s.isFullyInitialized()||q(n),s.isFiltered());return t1(t,o,n,r,e1,i)}function VV(t,e,n,r,i,s){let o;if(Uu(r,n)!=null)return e;{const a=new tg(r,e,i),l=e.eventCache.getNode();let u;if(q(n)||Q(n)===".priority"){let c;if(e.serverCache.isFullyInitialized())c=Lf(r,oi(e));else{const h=e.serverCache.getNode();C(h instanceof ee,"serverChildren would be complete if leaf node"),c=XS(r,h)}c=c,u=t.filter.updateFullNode(l,c,s)}else{const c=Q(n);let h=eg(r,c,e.serverCache);h==null&&e.serverCache.isCompleteForChild(c)&&(h=l.getImmediateChild(c)),h!=null?u=t.filter.updateChild(l,c,h,le(n),a,s):e.eventCache.getNode().hasChild(c)?u=t.filter.updateChild(l,c,ee.EMPTY_NODE,le(n),a,s):u=l,u.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=Lf(r,oi(e)),o.isLeafNode()&&(u=t.filter.updateFullNode(u,o,s)))}return o=e.serverCache.isFullyInitialized()||Uu(r,re())!=null,So(e,u,o,t.filter.filtersNodes())}}function FV(t,e){const n=oi(t.viewCache_);return n&&(t.query._queryParams.loadsAllData()||!q(e)&&!n.getImmediateChild(Q(e)).isEmpty())?n.getChild(e):null}function Tv(t,e,n,r){e.type===sn.MERGE&&e.source.queryId!==null&&(C(oi(t.viewCache_),"We should always have a full cache before handling merges"),C(xf(t.viewCache_),"Missing event cache, even though we have a server cache"));const i=t.viewCache_,s=xV(t.processor_,i,e,n,r);return NV(t.processor_,s.viewCache),C(s.viewCache.serverCache.isFullyInitialized()||!i.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),t.viewCache_=s.viewCache,bV(t,s.changes,s.viewCache.eventCache.getNode(),null)}function bV(t,e,n,r){const i=r?[r]:t.eventRegistrations_;return hV(t.eventGenerator_,e,n,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function NF(t){KM(ci),Jr(new mr("database",(e,{instanceIdentifier:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return RF(r,i,s,n)},"PUBLIC").setMultipleInstances(!0)),ln(Yy,Xy,t),ln(Yy,Xy,"esm2017")}kn.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};kn.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};NF();const xF=()=>{const[t]=Yp(Hr),[e,n]=A.useState(""),[r,i]=A.useState(0),[s,o]=A.useState([]),a=IM(BF,"message");A.useEffect(()=>{const u=IF(a);jM(u,c=>{let h=[];c.forEach(d=>{h.push({...d.data(),id:d.id}),h.sort((p,_)=>p.createAt.seconds-_.createAt.seconds)}),console.log(h),o(h)})},[]);const l=async()=>{var u,c;e!==""&&(i(r+1),await BM(a,{id:r,text:e,createAt:HM(),avatar:(u=Hr.currentUser)==null?void 0:u.photoURL,name:(c=Hr.currentUser)==null?void 0:c.displayName}),n(""))};return X.jsxs("div",{className:"chatapp",children:[X.jsx("div",{className:"chatwindow",children:s.map(u=>t.displayName!==u.name?X.jsxs("div",{className:"message",children:[X.jsx("div",{className:"avatar",style:{backgroundImage:`url(${u.avatar})`,borderRadius:"25px",marginLeft:"5px"}}),X.jsxs("div",{className:"text",children:[X.jsx("div",{className:"nick",style:u.name=="CHiKUSHka"?{color:"#ED726C",marginRight:"auto"}:{marginRight:"auto"},children:u.name}),u.text]})]}):X.jsxs("div",{className:"message",style:{marginLeft:"auto"},children:[X.jsxs("div",{className:"text",style:{backgroundColor:"#EFFDDE",marginRight:"5px"},children:[X.jsx("div",{className:"nick",style:u.name=="CHiKUSHka"?{color:"#ED726C",marginLeft:"auto"}:{marginLeft:"auto"},children:u.name}),u.text]}),X.jsx("div",{className:"avatar",style:{backgroundImage:`url(${u.avatar})`,borderRadius:"25px",marginRight:"5px"}})]}))}),X.jsxs("label",{className:"labelinput",children:[X.jsx("input",{className:"input",placeholder:"Сообщение",onChange:u=>{n(u.target.value)},value:e,onKeyDown:u=>{u.key=="Enter"&&l()}}),X.jsx("button",{className:"buttin",onClick:l})]})]})};const DF=()=>{const t=async()=>{const e=await ON(Hr,$F);console.log(e),await yA(Hd)};return X.jsx("div",{className:"container",children:X.jsx(zd,{to:Hd,children:X.jsx("button",{className:"butt",onClick:t,children:"Войти с помощью Google"})})})},OF=[{path:Wd,el:DF}],LF=[{path:Hd,el:xF}],MF=()=>{const[t]=Yp(Hr);return t?X.jsx(A_,{children:LF.map(({path:e,el:n})=>X.jsx($d,{path:e,Component:n},e))}):X.jsx(A_,{children:OF.map(({path:e,el:n})=>X.jsx($d,{path:e,Component:n},e))})};function VF(){return X.jsxs(zA,{children:[X.jsx(Px,{}),X.jsx(MF,{})]})}var FF="firebase",bF="10.3.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
