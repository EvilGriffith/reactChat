 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function NF(t){KM(ci),Jr(new mr("database",(e,{instanceIdentifier:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return RF(r,i,s,n)},"PUBLIC").setMultipleInstances(!0)),ln(Yy,Xy,t),ln(Yy,Xy,"esm2017")}kn.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};kn.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};NF();const xF=()=>{const[t]=Yp(Hr),[e,n]=A.useState(""),[r,i]=A.useState(0),[s,o]=A.useState([]),a=IM(BF,"message");A.useEffect(()=>{const c=IF(a);jM(c,h=>{let d=[];h.forEach(p=>{d.push({...p.data(),id:p.id}),d.sort((_,y)=>_.createAt.seconds-y.createAt.seconds)}),o(d)})},[]);const l=async()=>{var c,h;e!==""&&(i(r+1),await BM(a,{id:r,text:e,createAt:HM(),avatar:(c=Hr.currentUser)==null?void 0:c.photoURL,name:(h=Hr.currentUser)==null?void 0:h.displayName}),n(""))},u=()=>{setTimeout(()=>{document.querySelector(".chatwindow").scrollTop=9999},500)};return setTimeout(()=>{document.querySelector(".chatwindow").scrollTop=9999},1e3),q.jsxs("div",{className:"chatapp",children:[q.jsx("div",{className:"chatwindow",onChange:u(),children:s.map(c=>t.displayName!==c.name?q.jsxs("div",{className:"message",children:[q.jsx("div",{className:"avatar",style:{backgroundImage:`url(${c.avatar})`,borderRadius:"25px",marginLeft:"5px"}}),q.jsxs("div",{className:"text",children:[q.jsx("div",{className:"nick",style:c.name=="CHiKUSHka"?{color:"#ED726C"}:{},children:c.name}),q.jsx("div",{className:"textmes",children:c.text})]})]},c.id):q.jsxs("div",{className:"message",style:{marginLeft:"auto"},children:[q.jsxs("div",{className:"text",style:{backgroundColor:"#EFFDDE",marginRight:"5px"},children:[q.jsx("div",{className:"nick",style:c.name=="CHiKUSHka"?{color:"#ED726C"}:{},children:c.name}),q.jsx("div",{className:"textmes",children:c.text})]}),q.jsx("div",{className:"avatar",style:{backgroundImage:`url(${c.avatar})`,borderRadius:"25px",marginRight:"5px"}})]}))}),q.jsxs("label",{className:"labelinput",children:[q.jsx("input",{className:"input",placeholder:"Сообщение",onChange:c=>{n(c.target.value)},value:e,onKeyDown:c=>{c.key=="Enter"&&l()}}),q.jsx("button",{className:"buttin",onClick:l})]})]})};const DF=()=>{const t=async()=>{const e=await ON(Hr,$F);console.log(e),await yA(Hd)};return q.jsx("div",{className:"container",children:q.jsx(zd,{to:Hd,children:q.jsx("button",{className:"butt",onClick:t,children:"Войти с помощью Google"})})})},OF=[{path:Wd,el:DF}],LF=[{path:Hd,el:xF}],MF=()=>{const[t]=Yp(Hr);return t?q.jsx(A_,{children:LF.map(({path:e,el:n})=>q.jsx($d,{path:e,Component:n},e))}):q.jsx(A_,{children:OF.map(({path:e,el:n})=>q.jsx($d,{path:e,Component:n},e))})};function VF(){return q.jsxs(zA,{children:[q.jsx(Px,{}),q.jsx(MF,{})]})}var FF="firebase",bF="10.3.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
